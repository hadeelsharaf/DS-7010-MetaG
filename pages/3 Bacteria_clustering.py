...
from common import tidy_bacteria_data
...
st.header('Bacteria Dendrogram')
st.write(""" The dendrogram is applied to the Bacteria data after tidying the data. 
            The dendrogram is used to visualize the Bacteria data clustering using ward method.""")
...
st.header('Bacteria Dendrogram singel method')
